		...
		(
			...
			function()
			{
				...
				(
					...
					function()
					{
						var testFoxHound = libFoxHound.new(libFable).setDialect('English');
		...
		(
			...
			function()
			{
				...
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable).setLogLevel(5).setDialect('English').setScope('Animal');
						// Build the query
				...
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable).setScope('Animal');
						// Build the query
				...
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable).setScope('Animal').setDistinct(true);
						// Build the query
						tmpQuery.buildReadQuery();
						// This is the query generated by the English dialect
						Expect(tmpQuery.query.body)
				...
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable).setDialect('English').setScope('Animal').setDistinct(true);
