		...
		(
			...
			function()
			{
				...
				(
					...
					function()
					{
						var testFoxHound = libFoxHound.new(libFable).setDialect('ALASQLArray');
						Expect(testFoxHound.dialect.name)
							.to.equal('ALASQLArray');
						Expect(testFoxHound)
		...
		(
			...
			function()
			{
				...
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable)
							.setLogLevel(5)
							.setDialect('ALASQLArray')
							.setScope('Animal')
							.addRecord({IDAnimal:null, Name:'Foo Foo', Age:15});
						// Build the query
						tmpQuery.buildCreateQuery();
						// This is the query generated by the ALASQLArray dialect
						libFable.log.trace('Create Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal("INSERT INTO ? ( IDAnimal, Name, Age) VALUES ( :IDAnimal_0, :Name_1, :Age_2);");
					}
				);
				test
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable).setDialect('ALASQLArray');
						// Build the query
						tmpQuery.buildCreateQuery();
						tmpQuery.addRecord({});
						tmpQuery.buildCreateQuery();
				...
				(
					...
					function()
					{
						var tmpQuery = libFoxHound.new(libFable).setDialect('ALASQLArray').setScope('Animal');
						...
						Expect(tmpQuery.query.body)
							.to.equal('SELECT * FROM ? ORDER BY Cost DESC;');
					}
				);
				test
				(
					...
					function()
					{
						...
						Expect(tmpQuery.query.body)
							.to.equal('SELECT Name, Age, Cost FROM ? WHERE Age = :Age_w0 ORDER BY Age, Cost LIMIT 0, 10;');
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Select Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('SELECT Name, Age, Cost FROM ? WHERE Age = :Age_w0 AND ( Color = :Color_w2 OR Color = :Color_w3 ) AND Description IS NOT NULL AND IDOffice IN ( :IDOffice_w6 ) ORDER BY Age LIMIT 100;');
					}
				);
				test
				(
					...
					function()
					{
						...
						Expect(tmpQuery.query.body)
							.to.equal('SELECT Name, Age * 5, Cost FROM  ?  WHERE Age = :Age_w0  LIMIT 0, 10;');
					}
				);
				test
				(
				...
				(
					...
					function()
					{
						...
						libFable.log.trace('Custom Count Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('SELECT COUNT(*) AS RowCount FROM  ?  WHERE Age = :Age_w0;');
					}
				);
				test
				(
					...
					function()
					{
						...
						Expect(tmpQuery.query.body)
							.to.equal('UPDATE ? SET Age = :Age_0, Color = :Color_1 WHERE IDAnimal = :IDAnimal_w0;');
					}
				);
				test
				(
				...
				(
					...
					function()
					{
						...
						Expect(tmpQuery.query.body)
							.to.equal('DELETE FROM ? WHERE IDAnimal = :IDAnimal_w0;');
					}
				);
				test
				(
			...
			function()
			{
				...
				(
					...
					function()
					{
						...
						libFable.log.trace('Create Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal("INSERT INTO ? ( IDAnimal, GUIDAnimal, CreateDate, CreatingIDUser, UpdateDate, UpdatingIDUser, Deleted, Name, Age) VALUES ( NULL, :GUIDAnimal_1, NOW(), :CreatingIDUser_3, NOW(), :UpdatingIDUser_5, :Deleted_6, :Name_7, :Age_8);");
					}
				);
				test
				(
				...
				(
					...
					function()
					{
						...
						Expect(tmpQuery.query.body)
							.to.equal("INSERT INTO ? ( IDAnimal, GUIDAnimal, CreateDate, CreatingIDUser, UpdateDate, UpdatingIDUser, Deleted, DeletingIDUser, DeleteDate, Name, Age) VALUES ( :IDAnimal_0, :GUIDAnimal_1, :CreateDate_2, :CreatingIDUser_3, :UpdateDate_4, :UpdatingIDUser_5, :Deleted_6, :DeletingIDUser_7, :DeleteDate_8, :Name_9, :Age_10);");
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Select Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('SELECT Name, Age, Cost FROM ? WHERE  ?.Deleted = :Deleted_w0 LIMIT 100;');
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Select Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('SELECT Name, Age, Cost FROM ? WHERE Age = :Age_w0 AND ( Color = :Color_w2 OR Color = :Color_w3 ) AND Description IS NOT NULL AND IDOffice IN ( :IDOffice_w6 ) AND Deleted = :Deleted_w7 LIMIT 100;');
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Select Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('SELECT Name, Age, Cost FROM ? LIMIT 100;');
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Delete Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('UPDATE ? SET UpdateDate = NOW(), Deleted = 1, DeletingIDUser = :DeletingIDUser_2, DeleteDate = NOW() WHERE IDAnimal = :IDAnimal_w0 AND  ?.Deleted = :Deleted_w1;');
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Update Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('UPDATE ? SET GUIDAnimal = :GUIDAnimal_0, UpdateDate = NOW(), UpdatingIDUser = :UpdatingIDUser_2, Name = :Name_3, Age = :Age_4 WHERE IDAnimal = :IDAnimal_w0;');
					}
				);
				test
				(
					...
					function()
					{
						...
						libFable.log.trace('Update Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('UPDATE ? SET GUIDAnimal = :GUIDAnimal_0, Name = :Name_1, Age = :Age_2 WHERE IDAnimal = :IDAnimal_w0;');
					}
				);
				test
				(
				...
				(
					...
					function()
					{
						...
						libFable.log.trace('Update Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('UPDATE ? SET GUIDAnimal = :GUIDAnimal_0, UpdateDate = NOW(), UpdatingIDUser = :UpdatingIDUser_2, Deleted = :Deleted_3, Name = :Name_4, Age = :Age_5 WHERE IDAnimal = :IDAnimal_w0 AND Deleted = :Deleted_w1;');
					}
				);
				test
				(
