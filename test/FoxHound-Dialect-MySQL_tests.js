			...
			function()
			{
				...
				(
					...
					function()
					{
						...
						Expect(tmpQuery.query.body)
							.to.equal("INSERT INTO `Animal` ( IDAnimal, GUIDAnimal, CreateDate, CreatingIDUser, UpdateDate, UpdatingIDUser, Deleted, Name, Age) VALUES ( :IDAnimal_0, :GUIDAnimal_1, :CreateDate_2, :CreatingIDUser_3, :UpdateDate_4, :UpdatingIDUser_5, :Deleted_6, :Name_7, :Age_8);");
					}
				);
				test
				(
				...
				(
					...
					function()
					{
						...
						libFable.log.trace('Delete Query', tmpQuery.query);
						Expect(tmpQuery.query.body)
							.to.equal('UPDATE `Animal` SET UpdateDate = NOW(), Deleted = 1, DeletingIDUser = :DeletingIDUser_2, DeleteDate = NOW() WHERE IDAnimal = :IDAnimal_w0 AND  `Animal`.Deleted = :Deleted_w1;');
					}
				);
				test
				(
